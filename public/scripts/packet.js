  ...
  switch (type) {
    ...
    case "suspect":
      ...
      keys.forEach(
        (key) =>
          (relevantInfo[key] =
            numHostileMin1-- > 0 ? values[key].hostile : values[key].trusted)
      );
    ...
    case "hostile":
      ...
      keys.forEach(
        (key) =>
          (relevantInfo[key] =
            numHostileMin3-- > 0 ? values[key].hostile : values[key].trusted)
      );
      break;
